...
Hacking the Cozy Passwords app requires you to [setup a dev environment][setup].
...
After the build and the stack launched, your app is now available at http://cozy-passwords.cozy.tools:8080.
...
If you want to work on Passwords and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
- Chatting with us on IRC [#cozycloud on Libera.Chat][libera-chat]
...
Passwords is developed by cozycloud and distributed under the [AGPL v3 license][agpl-3.0].
...
[libera-chat]: https://web.libera.chat/#cozycloud
